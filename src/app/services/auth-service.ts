...
export class AuthService {
  ...
  auth(login:loginInterface):Observable<baseResponseInterface<string>>{
    return this.http.post<baseResponseInterface<string>>(this.baseUrl,login).pipe(map(response=>{
      return {
        data : response.data,
        success: true
      }
